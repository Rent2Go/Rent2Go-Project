...
public class ABIKPSPublicSoap
{
    ...
    public ABIKPSPublicSoap(){}

    public ABIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ABIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ABIExtendedSoapSerializationEnvelope envelope= new ABIExtendedSoapSerializationEnvelope(ABIExtendedSoapSerializationEnvelope.VER11);
