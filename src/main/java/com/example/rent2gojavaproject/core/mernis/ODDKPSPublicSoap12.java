...
public class ODDKPSPublicSoap12
{
    ...
    public ODDKPSPublicSoap12(){}

    public ODDKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public ODDKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ODDExtendedSoapSerializationEnvelope envelope= new ODDExtendedSoapSerializationEnvelope(ODDExtendedSoapSerializationEnvelope.VER12);
